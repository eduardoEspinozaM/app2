...
class ProyectsControllerTest < ActionController::TestCase
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post :create, proyect: { description: @proyect.description, file: @proyect.file, image: @proyect.image, title: @proyect.title }
    end
  ...
  test "should update proyect" do
    patch :update, id: @proyect, proyect: { description: @proyect.description, file: @proyect.file, image: @proyect.image, title: @proyect.title }
    assert_redirected_to proyect_path(assigns(:proyect))
  end
